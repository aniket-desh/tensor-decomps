...
def generate_tensor(tenpy, args):  
    ...
    elif args.tensor == "C_core": 
        T_true, T, cov_empirical,cov_pinv_empirical, M_empirical_pinv =                   synthetic_tensors.Generate_C_core(tenpy, dims, args.s, args.k, args.epsilon, args.seed) 
    #################################################################
