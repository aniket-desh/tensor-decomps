...
from reconstruction_c_hat_MW import compute_C_hat, reconstructed_maxwellian, reconstructed_maxwellian_ana, svd_decomposition_truncated, compute_C_hat_Gau, reconstructed_Gaussian, compute_C_hat_constant, reconstructed_constant, Error
...
################################################################################
    ...
    for number_samples in sample_sizes:
        ...
        # Compute C_hat 
        C_hat = compute_C_hat_constant(phi_basis_x, x_samples, D)
        #print((C_hat))
        # print((M1))
        # print(x_samples)
        # Compute C
