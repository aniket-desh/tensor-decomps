...
def parse_arguments():
    ...
    type=float,
    nargs='+',
    default=[0.5, 0.5, 0.5, -0.5, -0.5, 0.5, 0.0, -0.5, -0.5],
    help='means for each Gaussian component (default: 0.5 0.5 0.5 -0.5 -0.5 0.5 0.0 -0.5 -0.5)'
)
    parser.add_argument(
    '--variances',
    type=float,
    nargs='+',
    default=[0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05, 0.05],
    help='variances for each Gaussian component (default: 0.05 0.05 0.05 ... 0.05)'
)
    parser.add_argument(
    '--weights',
    type=float,
    nargs='+',
    default=[0.3, 0.3, 0.4],
    help='weights for each Gaussian (default: 0.3, 0.3, 0.4)'
)
    ...
    parser.add_argument(
        '--degree_x',
        type=int,
        default=17, help='Degree of spatial basis functions x(default: 3)')
    parser.add_argument(
        '--degree_y',
        type=int,
        default=17, help='Degree of spatial basis functions y(default: 3)')
    parser.add_argument(
        '--degree_z',
        type=int,
        default=17, help='Degree of spatial basis functions z(default: 3)')
    ...
    parser.add_argument(
        ...
        help='choose spatial basis functions to test, available: B-spline, Chebyshev, Legendre, Fourier, Gausian (default: B-spline)')
    parser.add_argument(
        ...
        help='choose velocity basis functions to test, available: B-spline, Chebyshev, Legendre, Fourier, Gausian (default: B-spline)')
    ####################################################################
    parser.add_argument(
        '--tol_restart_dt',
        default=0.01,
    ...
    parser.add_argument(
        ...
        default=20,
        metavar='int',
        help='Input tensor size in each dimension (default: 20)')
    parser.add_argument(
        '--R',
        type=int,
        default=10,
...
def add_general_arguments(parser):
    ...
    parser.add_argument(
        ...
        default=10,
        metavar='int',
        help='Input CP decomposition rank (default: 20)')
    parser.add_argument(
        '--r',
        type=int,
        default=20,
        metavar='int',
        help='Update rank size (default: 20)')
    parser.add_argument(
        '--R-app',
        type=int,
        default=10,
    ...
    parser.add_argument(
        ...
        help='choose tensor to test, available: noisy_tensor, C_core, random, negrandom,randn, random_col, mm, mom_cons, mom_cons_sv, amino, coil100, timelapse, scf (default: noisy_tensor)')
    parser.add_argument(
        '--tlib',
        default="numpy",
        metavar='string',
